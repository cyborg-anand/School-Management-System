...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 9, 14, 8, 0, 0),
    end: new Date(2024, 9, 14, 8, 45,0),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 9, 15, 15, 0),
    end: new Date(2024, 9, 15, 15, 45),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2024, 9, 19, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 9, 19, 9, 0),
    end: new Date(2024, 9, 19, 9, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 9, 19, 11, 0),
    end: new Date(2024, 9, 19, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 9, 19, 13, 0),
    end: new Date(2024, 9, 19, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 9, 19, 14, 0),
    end: new Date(2024, 9, 19, 14, 45),
  },
];